                    ...
                    <div id="section">
                        ...
                        <div id="inner-card">
                            <div id="inner-inner-card">
                                <form action="login-customer" id="form">
                                    <h4>Account Number</h4>
                                    <div class="inputForms">
                                        <input type="text" pattern="^[0-9]{12,12}$" name="acc" class="fg1" required>
                                    </div>
                                    <h4>Pincode</h4>
                                    <div class="inputForms">
                                        <input type="password" name="pincode" class="fg1" required>
                                    </div>
                                    <div id="msg-cont">
                                        <p id="message">
                                            <%= message %>
                                    ...
                                    <div id="buttons">
                                        ...
                                        <button id="cus">Employee Login</button>
                                    </div>
                                </form>
                            </div>
                        </div>
